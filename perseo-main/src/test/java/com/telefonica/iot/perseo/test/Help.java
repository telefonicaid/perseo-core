    ...
    public static String[] ExampleRules() {
        return new String[]{
            // Put here all EPL text rules to be compiled at test execution time
                 ...
                 ,"insert into mynewstream select window(price) as winprice from iotEvent.win:length(2) where price>30; select *, winprice.get(0) as primero from mynewstream having count(winprice)>1 and winprice.lastOf()>40;"
